...
{
	private File myFile = new File("data/test.xlsx");
	...
	public void ReadWriteTest()  throws Exception
	{
		...
		assertEquals (c.getCellType() , Cell.CELL_TYPE_FORMULA);
		assertEquals (c.getCachedFormulaResultType() , HSSFCell.CELL_TYPE_NUMERIC );
